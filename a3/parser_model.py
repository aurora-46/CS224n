...
class ParserModel(nn.Module):
    ...
    def embedding_lookup(self, w):
        ...
        ### END YOUR CODE
        return self.embeddings[w].view(w.shape[0],w.shape[1]*self.embed_size)
    ...
    def forward(self, w):
        ...
        hidden=self.dropout(torch.relu(self.embedding_lookup(w)@self.embed_to_hidden_weight+self.embed_to_hidden_bias))
